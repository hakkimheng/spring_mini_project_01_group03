...
import org.example.miniproject.model.dto.response.*;
...
public class ArticleController extends BaseResponse {
    ...
    public ResponseEntity<ApiResponse<ArticleWithListCommentResponse>> getAllComments(@PathVariable("article-id") Integer articleId) {
        return responseEntity(true,"Get article with comments successfully",
                HttpStatus.OK,commentService.getAllCommentByArticleId(articleId));
    }
